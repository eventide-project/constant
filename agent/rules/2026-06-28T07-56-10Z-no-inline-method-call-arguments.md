...
```ruby
# No
new(namespace.const_get(name_or_value, inherit))

# Yes
raw_constant = namespace.const_get(name_or_value, inherit)
new(raw_constant)
```
