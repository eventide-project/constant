...
passes through the **loop** (the distributed OODA cycle; see the TDD lexicon).
...
**Format:**
- Filename `YYYY-MM-DD-<feature-slug>.md` (the feature's date, like plans/designs).
...
decision-log entries separate and intact. Related: the TDD lexicon (loop, hinge,
gate, deliberation) and the hinge-cycle rule.
