...
**Why:** "Controls" is the established TestBench vocabulary the user works in; "factory" is foreign terminology that the user does not want mixed in. (The project `AGENTS.md` once described them parenthetically as "factories for building example constants," which seeded earlier slips — that parenthetical has been corrected.)
