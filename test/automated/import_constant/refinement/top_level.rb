...
context "Import Constant" do
  context "Refinement" do
    context "Top Level" do
      ...
      control_source_name = "SomeSource"

      control_script = Controls::Script.top_level_refinement_import(
        source_name: control_source_name,
      ...
      control_constant_full_names =
        control_inner_constant_names.map do |inner_constant_name|
          "#{control_source_name}::#{inner_constant_name}"
        end
